...
public record Problem(
    ...
    [property: Required(ErrorMessage = "Problem type URI is required")]
    string type,
    
    [property: JsonPropertyName("title")]
    [property: Required(ErrorMessage = "Problem title is required")]
    string title,
    
    [property: JsonPropertyName("status")]
    [property: Range(100, 599, ErrorMessage = "HTTP status must be between 100 and 599")]
    int status,
    ...
    [property: Required(ErrorMessage = "Problem instance is required")]
    string instance
)
{
    /// <summary>
